const HomeAbout: React.FC = () => {
  return(
	...
	<p className="p-2 text-sm">　本サイトは筆者が普段の業務で学んだこと、日常的に勉強したこと、各種環境構築などを記録した備忘録です。色んなジャンルに手を出してますがメイントピックはデータ分析、自然言語処理、建築 x IT です。なにかありましたら X (旧Twitter) でご連絡ください。</p>
	...
	<ul className="list-disc ml-8 text-sm">
	  ...
	  <li>建築・建設 x ITに関するお話 (Architecture)</li>
